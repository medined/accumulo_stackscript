...
tar xfz $BASE_DIR/software/accumulo/target/$MY_ACCUMULO_VERSION-dist.tar.gz -C $BASE_DIR/bin

# Compile the native libraries
pushd $BASE_DIR/bin/$MY_ACCUMULO_VERSION/src/server/src/main/c++; make; popd
